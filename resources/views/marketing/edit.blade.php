...
@section('content')
    <div class="page-heading" style="margin-bottom:24px;">
        <div>
            <h2 style="font-size:20px; font-weight:700; color:#1E293B; margin:0;">Edit Salesman</h2>
            <p style="font-size:12px; color:#64748B; margin:4px 0 0 0;">Ubah data anggota marketing</p>
        </div>
    </div>
