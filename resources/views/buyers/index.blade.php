...
@section('content')
    <div class="page-heading" style="align-items:center; gap: 12px; flex-wrap: wrap;">
        <div>
            <h1 class="heading-title">Pelanggan</h1>
        </div>
        <div style="flex:1; min-width:260px; display:flex; gap:8px; align-items:center; justify-content:flex-end; flex-wrap:wrap;">
            <div style="position:relative; flex:1; min-width:220px; max-width:340px;">
                ...
                <div id="buyerSuggestions" style="display:none; position:absolute; z-index:10; left:0; right:0; background:#fff; border:1px solid #e5e7eb; border-radius:10px; margin-top:6px; box-shadow:0 10px 28px rgba(17,24,39,0.08); max-height:220px; overflow:auto;">
                </div>
            </div>
            <a href="{{ route('buyers.create') }}" class="chip is-active" style="box-shadow: 0 10px 22px rgba(156, 15, 47, 0.28); display:flex; align-items:center; gap:8px; white-space:nowrap;">
    ...
    <div class="card" style="padding: 0;">
        <table class="table-clean">
            ...
            <tbody id="buyersTableBody">
                @forelse ($buyers as $buyer)
                    <tr data-buyer-row data-name="{{ Str::lower($buyer->name) }}">
                        ...
                        <td style="padding-left:14px; white-space: nowrap;">
                            <a href="{{ route('buyers.edit', $buyer) }}" class="btn" style="padding:8px 10px; border-color:#e5e7eb;">Edit</a>
                ...
                @empty
                    <tr><td colspan="5" style="text-align:center; padding:18px;">Belum ada data</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
