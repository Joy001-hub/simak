...
@section('content')
    <div class="page-heading" style="align-items:center;">
        <div>
            <h2 class="text-xl font-bold text-text-main tracking-tight">Projects</h2>
        </div>
        <a href="{{ route('projects.create') }}" class="chip is-active" style="box-shadow: 0 10px 22px rgba(156, 15, 47, 0.28); display:flex; align-items:center; gap:8px;">
        ...
        @foreach ($projects as $project)
            ...
            <tr>
                ...
                <td style="padding-left:14px; white-space: nowrap;">
                            <a href="{{ route('projects.edit', $project) }}" class="btn light" style="padding:8px 10px; border-color:#e5e7eb;">Edit</a>
