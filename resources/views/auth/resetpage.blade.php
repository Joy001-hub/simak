    ...
    <div class="relative z-10 w-full max-w-md">
        <div class="bg-white/95 backdrop-blur rounded-2xl shadow-2xl border border-white/30 overflow-hidden">
            ...
            <div class="px-8 pt-8 pb-6 text-center border-b border-slate-200">
                ...
                <h1 class="text-2xl font-bold text-slate-900">Reset Lisensi</h1>
                <p class="text-sm text-slate-600 mt-2">Masukkan email dan password untuk reset lisensi.</p>
            </div>
            ...
            {{-- Form --}}
            <form id="reset-form" action="{{ route('auth.reset') }}" method="POST" class="px-8 py-8 space-y-5">
                @csrf
                <div>
                ...
                <p class="text-center text-sm text-slate-600 mt-4">
                    Login <a href="/login" class="text-[#b91c3b] font-semibold hover:underline">disini</a>
                </p>
            </form>
