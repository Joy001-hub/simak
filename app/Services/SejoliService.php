...
class SejoliService
{
    ...
    /**
     * Create HTTP client with optimized timeout settings
     * - Connect timeout: 8 seconds (reduced from 10)
     * - Request timeout: 20 seconds (reduced from 30)
     * - Retry: 1 time with 1.5s delay (reduced from 2 retries)
     */
    private function http(): PendingRequest
    {
        ...
        return Http::withOptions([
            ...
            ->acceptJson()
            ->connectTimeout(8)  // Reduced from 10s
            ->timeout(20)        // Reduced from 30s
            ->retry(1, 1500, throw: false);  // Reduced from 2 retries
    }
